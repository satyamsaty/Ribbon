#!/bin/bash
file=`ssh  -o  "StrictHostKeyChecking no" -p 2024 -i /home/ansible/cloud_ats.key root@$1 "ls -lrtha /var/log/sonus/sbx/evlog/*.SYS | tail -n 2 | head -1"`
#echo "\n\n\nFile value is $file\n\n\n"
...
a=` ssh -o   "StrictHostKeyChecking no" -p 2024 -i /home/ansible/cloud_ats.key root@$1 "cd /var/log/sonus/sbx/evlog ;cat $b| grep -w \".NRS: Got AMF deactivate command\"" `
#echo " value is $a " 
...
#a=` ssh -o   "StrictHostKeyChecking no" -p 2024 -i /home/ansible/cloud_ats.key root@$1 "cd /var/log/sonus/sbx/evlog ;cat $b| grep -w \".NRS: Got AMF deactivate command\" | awk -F\" \" '{ print \$3}' | tr -s \" \" | awk -F: '{print \$1}'" `
c=` ssh -o   "StrictHostKeyChecking no" -p 2024 -i /home/ansible/cloud_ats.key root@$2 "cd /var/log/sonus/sbx/evlog ;cat $d| grep -w \".RTM: Switchover processing complete for all subsystems\"" `
#echo "\n\n\nC value is $c\n\n\n"
